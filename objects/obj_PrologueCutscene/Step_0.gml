...
switch (PrologueCutscene_Stage)
{
	...
	case PROLOGUECUTSCENE.ENTER:
		...
		#region Enter
			...
			{
				SkipCutsceneOption(PrologueCutscene_EnterSequence);
			}
	...
	case PROLOGUECUTSCENE.STAR_APPROACH:
		...
		#region Star Approach
			...
			else
			{
				...
				SkipCutsceneOption(PrologueCutscene_StarApproach_StarSequence);
				if (PrologueCutscene_StarApproach_WhiteSequence != noone)
				{
					SkipCutsceneOption(PrologueCutscene_StarApproach_WhiteSequence);
				}
